...
4. [Mainメソッドで2つの値を記入し、合計のメソッド、平均のメソッドに渡し、結果をメインメソッドで出力する](https://github.com/harusaki-32/JavaLessonLv4/blob/main/LessonLv4_4.java)
5. [mensekiメソッドで底辺の長さがbase、高さがheightで表される三角形の面積を計算し、メインメソッドに返し、表示する](https://github.com/harusaki-32/JavaLessonLv4/blob/main/LessonLv4_5.java)
